...
function preload(){
  ...
  blast = loadImage("assets/blast.webp");
...
text("Lives = " + life,displayWidth-200,displayHeight/2-310)
...
function enemy(){
  if(frameCount%100===0){
    ...
    var zombie = createSprite(width, Math.round(random(200,500)),40,10);
